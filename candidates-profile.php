        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="content-single">
                    ...
                    <p>
                        Hi, I am <strong>Danica Lewis,</strong> a professional Ui/Ux and Graphic designer with 4+ years
                        of experience. I can design website ui, app ui, dashboard ui, thank you card, logo, flyer,
                        brochure, banner, etc. If you need any help just give me a knock. Looking forward to working
                        with you!
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis illum fuga eveniet. Deleniti
                    ...
                    <div class="block-progress-status">
                        <div class="item-progress">
                            <div class="title-progress"><strong class="text-md-bold">Figma</strong> (8.5/10)</div>
                        ...
                        <div class="item-progress">
                            <div class="title-progress"><strong class="text-md-bold">Sketch</strong> (8.5/10)</div>
                            <div class="info-progress">
                                <div class="progress">
                        ...
                        <div class="item-progress">
                            <div class="title-progress"><strong class="text-md-bold">After Effect</strong> (8.5/10)
                            </div>
                            <div class="info-progress">
                                <div class="progress">
                        ...
                        <div class="item-progress">
                            <div class="title-progress"><strong class="text-md-bold">Photoshop</strong> (8.5/10)</div>
                            <div class="info-progress">
                                <div class="progress">
                        ...
                        <div class="item-progress">
                            <div class="title-progress"><strong class="text-md-bold">HTML & CSS</strong> (8.5/10)</div>
                            <div class="info-progress">
                                <div class="progress">
