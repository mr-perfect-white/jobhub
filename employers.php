...
<section class="section-box-2   design-select-box-1">
...
<section class="section-box mt-80">
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-xl-9 col-md-12 col-sm-12 col-12 float-right">
                        ...
                        <div class="card-employers hover-up wow animate__animated animate__fadeIn">
                            <div class="row align-items-center">
                                <div class="col-lg-5 col-md-6 d-flex align-items-center">
                                    <div class="employers-logo mr-15">
                                        <a href="candidates.php">
                                            <figure><img alt="jobhub" src="assets/imgs/page/employers/employer1.png" />
                                            </figure>
                                        </a>
                                    </div>
                                ...
                                <div class="col-lg-9 job-tags mt-15">
                                    <a href="candidates-grid.html" class="hover-up">HTML5</a>
                        ...
                        <div class="card-employers hover-up wow animate__animated animate__fadeIn">
                            <div class="row align-items-center">
                                <div class="col-lg-5 col-md-6 d-flex align-items-center">
                                    <div class="employers-logo mr-15">
                                        <a href="candidates.php">
                                            <figure><img alt="jobhub" src="assets/imgs/page/employers/employer2.png" />
                                            </figure>
                                        </a>
                                    </div>
                                    <div class="employers-name">
